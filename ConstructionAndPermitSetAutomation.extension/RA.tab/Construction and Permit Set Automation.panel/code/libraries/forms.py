...
from libraries.ViewCreation import CreateFloorPlans, CreateElevations
...
class CreateProjectForm(BaseForm):
    ...
    def __init__(self):
        ...
        self.projectOptionsChListBox.Items.Add("Import Views", True)
        self.projectOptionsChListBox.Items.Add("Import Sheets", True)
        self.projectOptionsChListBox.Items.Add("Import Annotations", True)
        self.projectOptionsChListBox.Items.Add("Import Product Data", True)
...
class CreateProjectForm_ChooseOption(BaseForm):
    ...
    def onAcceptButtonClick(self, sender, args):
        ...
        if self.selectedOption:
            ...
            filePath = r"C:\Users\Ricardo Salas\Desktop\Temporal\Ciel V2-DesignOption02_A_detached.rvt"

            importFromExistingProject(filePath)
            createTopography()

            collectedConceptualElements = collectConceptualElements()
            replaceConceptualElements(collectedConceptualElements, self.selectedOption)
